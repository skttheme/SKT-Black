...
<?php } ?>
 <div id="footer-wrapper">
        ...
        <div class="copyright-wrapper">
        	<div class="copyright">
            	<div class="copyright-txt"><?php if( of_get_option('copytext',true) != ''){ echo of_get_option('copytext',true); }; ?><?php esc_html_e(' Theme By ','skt-black');?><a href="<?php echo esc_url('https://www.sktthemes.org/product-category/personal/');?>" target="_blank">
        <?php esc_html_e('SKT Personal Themes','skt-black'); ?>
        </a></div>                 
            </div>
            <div class="clear"></div>
        </div>
